...
const UserSection: React.FC<UserSectionProps> = ({
  ...
  const handleLoginClick = () => {
    ...
    // Also call parent's onLoginClick if needed
    onLoginClick();
  };

  const handleLoginSuccess = async (authenticatedUser: UserType | null) => {
    console.log('[UserSection] Login successful:', authenticatedUser);
  ...
  return (
    <>
      ...
      {/* Login Modal - Rendered at root level with high z-index */}
      <LoginModal
